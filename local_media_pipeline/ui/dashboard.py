...
class DashboardPage(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        setting_row.addWidget(self.path_btn)
        setting_row.addWidget(self.init_btn)
        ...
        for b in [self.scan_btn, self.pause_btn, self.stop_btn]:
            scan_btn_row.addWidget(b)
        ...
        scan_layout.addLayout(setting_row)
    ...
    def on_pause_resume(self) -> None:
        ...
        if not self.is_paused:
            self.scan_worker.request_pause()
            self.is_paused = True
            self.pause_btn.setText("继续扫描")
        else:
            self.scan_worker.request_resume()
            self.is_paused = False
            self.pause_btn.setText("暂停扫描")
